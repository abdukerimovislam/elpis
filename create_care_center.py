...
class CareCenterScreen extends StatelessWidget {
        ...
        children: [
          ...
          CustomScrollView(
            ...
            slivers: [
              ...
              // ЕЖЕДНЕВНОЕ (Daily)
              _buildSectionHeader(context, "Ежедневное", Icons.wb_sunny_rounded, 0),
              SliverPadding(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _WowCard(
                          ...
                          onTap: () => _openFullScreen(context, const KickCounterSheet()),
                          delay: 150,
                        ),
                      ),
                    ],
              ...
              // ЗДОРОВЬЕ (Health)
              _buildSectionHeader(context, "Здоровье & Роды", Icons.favorite_rounded, 1),
              SliverPadding(
                padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                sliver: SliverToBoxAdapter(
                  child: Row(
                    children: [
                      Expanded(
                        ...
                        child: _WowCard(
                          ...
                          height: 140, 
                          onTap: () => _openFullScreen(context, const ContractionTimerSheet()),
                          delay: 300,
                        ),
                      ),
                      const SizedBox(width: 12),
                    ...
                    children: [
                      Expanded(
                        child: _WowCard(
                          ...
                          onTap: () => _openSheet(context, const IsItNormalSheet()),
                          delay: 450,
                        ),
                      ),
                      const SizedBox(width: 12),
              ...
              // СЕМЬЯ (Family)
              _buildSectionHeader(context, "Семья & Воспоминания", Icons.diversity_1_rounded, 2),
              SliverPadding(
                padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                sliver: SliverToBoxAdapter(
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: _WowCard(
                          ...
                          onTap: () => _openSheet(context, const BumpGallerySheet()),
                          delay: 600,
                        ),
                      ),
                    ],
...
with open('lib/features/health/presentation/care_center_screen.dart', 'w') as f:
    f.write(new_content)

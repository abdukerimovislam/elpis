        ...
        children: [
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF8E9BAE)
                      .withValues(alpha: 0.2), // Тень цвета Sage/Blue
                  blurRadius: 40,
                  spreadRadius: -10,
          ...
          ClipOval(
            child: BackdropFilter(
              filter: ImageFilter.blur(
                  sigmaX: 10, sigmaY: 10), // Размытие фона за сферой
              child: Container(
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Colors.white.withValues(alpha: 0.4), // Светлый верх
                      Colors.white.withValues(alpha: 0.1), // Прозрачный низ
                    ],
                    stops: const [0.1, 1.0],
                  ),
                  border: Border.all(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(
                    Radius.elliptical(size * 0.25, size * 0.15)),
                ...
                begin: 0.5, end: 0.8, duration: 2000.ms), // <--- Анимация здесь
          ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.all(
                      Radius.elliptical(size * 0.3, size * 0.1)),
...
class _GravityFreeActorState extends State<GravityFreeActor>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final offset =
            10.0 * (0.5 - _controller.value); // Амплитуда 10 пикселей

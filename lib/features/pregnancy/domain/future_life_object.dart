...
class FutureLifeObject {
  ...
  final String momentDescription; // Эмоциональное описание момента (Например: "Фундамент башни...")
  final String? assetPath;       // Путь к картинке (в будущем здесь будет красивое фото предмета)
